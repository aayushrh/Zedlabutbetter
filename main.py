...
GROUNDLVL = H
MAIN_FONT = pygame.font.Font("fourside.ttf", 10)
...
class Player(pygame.sprite.Sprite):
    def __init__(self, plg, width, height, x, y, speed, jpheight, keys):
        super().__init__()
    ...
    def update(self):
        ...
        SCREEN.blit(MAIN_FONT.render("test", True, "#000000"), (0, 0))

def main():
    plgroup = pygame.sprite.Group()
    plgroup.add(Player(plgroup, 20, 50, 10, 10, 4, 15, {
        "lf": pygame.K_a,
        "rt": pygame.K_d,
        "jp": pygame.K_w,
        "sp": pygame.K_s
    }))
    plgroup.add(Player(plgroup, 20, 50, W - 30, 10, 2, 20, {
        "lf": pygame.K_LEFT,
        "rt": pygame.K_RIGHT,
        "jp": pygame.K_UP,
        "sp": pygame.K_DOWN
